...
function check_button(){
	...
	if(button==1){
		...
		$("#gallery-header-center-left-title").html('Todo');
		}
	if(button==2){
		$("#filter-studio").addClass(button_class);
		$("#gallery-header-center-left-title").html('Videos');
		}
	if(button==3){
		$("#filter-landscape").addClass(button_class);
		$("#gallery-header-center-left-title").html('Experimentacion');
		}
  if(button==4){
		$("#filter-illustration").addClass(button_class);
		$("#gallery-header-center-left-title").html('Dibujos');
		}
}
...
// Here are defined the filters for the "works" gallery
...
$("#filter-illustration").click(function() {  $container.isotope({ filter: '.illustration' }); button = 4; check_button();  });
